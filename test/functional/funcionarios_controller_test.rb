...
class FuncionariosControllerTest < ActionController::TestCase
  ...
  test "should create funcionario" do
    assert_difference('Funcionario.count') do
      post :create, funcionario: { codigo: @funcionario.codigo, email: @funcionario.email, endereco: @funcionario.endereco, funcao: @funcionario.funcao, nome: @funcionario.nome, senha: @funcionario.senha }
    end
  ...
  test "should update funcionario" do
    put :update, id: @funcionario, funcionario: { codigo: @funcionario.codigo, email: @funcionario.email, endereco: @funcionario.endereco, funcao: @funcionario.funcao, nome: @funcionario.nome, senha: @funcionario.senha }
    assert_redirected_to funcionario_path(assigns(:funcionario))
  end
